 ...
 * latest datasets, and sampling area counts.
 */

import {Router} from 'express'
import { getSpeciesCounts, getTraitsDataCounts, getLocationOrganismsCounts, getLatestDatasets, getSamplingAreaCounts, getDashboardStats } from '../controllers/home.controllers.js';
...
router.get('/home_report/sampling_area_counts', getSamplingAreaCounts);
router.get('/home_report/dashboard_stats', getDashboardStats);
